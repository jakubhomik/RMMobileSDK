...
typedef enum : NSUInteger {
    ...
    GET_CAR_MODEL = 1320,
    SET_CAR_MODEL = 1330,
    UPGRADE_MULTIPLE_COMMUNICATION1 = 1340,
    UPGRADE_MULTIPLE_COMMUNICATION2 = 1350,
    UPGRADE_B3AudibleVisual = 1360,//B3声光报警,
    UPGRADE_OFFMAP = 1370,
...
typedef enum : NSUInteger {
    ...
    IMPORT_UPGRADE_KEY,
    CLEAR_UPGRADE_KEY,
    IMPORT_DATA_SAFE_PRIVATE_KEY,
    CLEAR_DATA_SAFE_PRIVATE_KEY,
    IMPORT_DATA_SAFE_PUBLIC_KEY,
    CLEAR_DATA_SAFE_PUBLIC_KEY,
    ENABLE_DATA_SAFE_PUBLIC_KEY,
    EXPORT_ESS_PARAM_LIST,
    IMPORT_ESS_PARAM_LIST,
