...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/RMTelephone/RMAppFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lite' => 'lite@streamax.com' }
  s.source           = { :git => 'https://github.com/RMTelephone/RMAppFramework.git', :tag => s.version.to_s }
